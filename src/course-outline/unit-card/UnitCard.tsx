...
import CourseOutlineUnitCardContentSlot from '@src/plugin-slots/CourseOutlineUnitCardContentSlot';
import CourseOutlineUnitCardAddComponentSlot from '@src/plugin-slots/CourseOutlineUnitCardAddComponentSlot';
